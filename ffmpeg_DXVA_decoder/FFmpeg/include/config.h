...
#define FFMPEG_CONFIGURATION "--prefix=/i/github/FFmpeg/install/win/x86_x64/nv-10.1-qsv-vpl --enable-shared --disable-static --enable-gpl --enable-libx264 --enable-cuda-nvcc --enable-libvpl --enable-libnpp --enable-nonfree --toolchain=msvc --extra-cflags='-I/i/github/FFmpeg/third/libx264-x64/include -I/i/github/FFmpeg/third/nv-sdk-v10.1/include/cuda' --extra-ldflags='-LIBPATH:/i/github/FFmpeg/third/libx264-x64/lib -LIBPATH:/i/github/FFmpeg/third/nv-sdk-v10.1/lib/cuda/x64'"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2023
#define FFMPEG_DATADIR "/i/github/FFmpeg/install/win/x86_x64/nv-10.1-qsv-vpl/share/ffmpeg"
#define AVCONV_DATADIR "/i/github/FFmpeg/install/win/x86_x64/nv-10.1-qsv-vpl/share/ffmpeg"
#define CC_IDENT ""
